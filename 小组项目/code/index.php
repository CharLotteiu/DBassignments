...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
                <!-- MyTodo LOGO -->
				<a href="##"><img width="100" height="25" src="assets/img/logo-dark.png" alt="MyTodo Logo" class="img-responsive logo"></a>
			</div>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="index.php" class="active"><i class="lnr lnr-home"></i> <span>我的一天</span></a></li>
                    ...
                    <div class="row">
						<div class="col-md-8" id="todo">    
                            ...
                            <div class="panel" id="todolist">
								...
								?>
                                    <h3 class="panel-title">又是元气满满的一天，计划完成哪些任务？</h3>
									<div class="right">
                                ...
                                <div class="panel-body">
                                    <ul class="list-unstyled todo-list">
                                        <?php
										    //Created by 张晓彤 Edited by 刘玲玲 苏珊，查询数据库信息并显示
						...
						<div class="col-md-4" id="leftspace" style="display:inline-block;"> 
							<!-- TODO Filter -->
	...
	function status_toggle(ele_id,tid, status){
        $.ajax({
            ...
            success:function(result){
				...
				$( "#todo" ).load( "index.php #todolist", function( response, status, xhr ) {
					if ( status == "error" ) {
						var msg = "对不起，但是有一个错误: ";
						$( "#error" ).html( msg + xhr.status + " " + xhr.statusText );
					}
