...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `privacy` int(100) NOT NULL DEFAULT '0',
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=32 ;
...
INSERT INTO `user` (`uid`, `email`, `user_name`, `password`, `role`, `privacy`) VALUES
(0, 'admin@123.com', 'ADMIN', '123', 0, 0);
